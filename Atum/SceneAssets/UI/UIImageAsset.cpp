...
void UIImageAssetInst::BindClassToScript()
{
	...
	scripts.engine->RegisterObjectMethod(scriptClassName.c_str(), "void SetSpriteFromAsset(string&in)", WRAP_MFN(UIImageAssetInst, SetSpriteFromAsset), asCALL_GENERIC);
}
