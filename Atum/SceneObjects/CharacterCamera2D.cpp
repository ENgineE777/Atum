...
void CharacterCamera2D::BindClassToScript()
{
	...
	scripts.engine->RegisterObjectProperty(scriptClassName.c_str(), "float target_pos_x", memberOFFSET(CharacterCamera2D, target_pos.x));
	scripts.engine->RegisterObjectProperty(scriptClassName.c_str(), "float target_pos_y", memberOFFSET(CharacterCamera2D, target_pos.y));
